...
#define OS_RESOURCE_BEGIN(core)                                                        
#define OS_RESOURCE_DEF(Name,CeilingPrio,AuthorizedTasks)                     
#define OS_RESOURCE_END                                                          


#define OS_INTERRUPT_BEGIN(core)                                                extern const OsInterruptConfigType IsrLookupTable_core##core[];
...
#define OS_INTERRUPT_BEGIN(core)                                                 const OsInterruptConfigType IsrLookupTable_core##core[] = {
...
#define OS_TASK_BEGIN(core)                                                         static const OsTcbType* OsTasksConfig_core##core[OS_NUMBER_OF_TASKS] = {
...
#define OS_ALARM_BEGIN(core)                                                        static const OsAlarmConfigType* OsAlarmsConfig_core##core[OS_NUMBER_OF_ALARMS]={
...
#elif defined(OS_GEN_OCB_PER_CORE)

#define OS_MULTICORE_BEGIN
#define OS_CONFIG_BEGIN(core)                                                      volatile Ocb_t OCB_Cfg_core##core = { 

#define OS_TASK_BEGIN(core)                                                             (OsTcbType**)&OsTasksConfig_core##core[0],
...
#define OS_ALARM_BEGIN(core)                                                            (OsAlarmConfigType**)&OsAlarmsConfig_core##core[0],
#define OS_ALARM_DEF(Name,Action,Event,task,Callback)
#define OS_ALARM_AUTO_DEF(Name,Increment,Cycle,Action,Event,task,Callback)
#define OS_ALARM_END

#define OS_RESOURCE_BEGIN(core)                                                         (OsResourceConfigType**)&OsResourcesConfig_core##core[0],
#define OS_RESOURCE_DEF(Name,CeilingPrio,AuthorizedTasks)                     
#define OS_RESOURCE_END
...
#define OS_MULTICORE_BEGIN                                                          volatile Ocb_t* OCB_Cfg[] = {
#define OS_CONFIG_BEGIN(core)                                                      (volatile Ocb_t*)&OCB_Cfg_core##core, /* virtual core, it could be mapped to any physical core id */
...
#define OS_INTERRUPT_BEGIN(core)                                                       osVectoredIVT:
...
#define OS_INTERRUPT_BEGIN(core)                                                       osLookupIVT:
