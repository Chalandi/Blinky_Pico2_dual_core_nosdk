...
OS_MULTICORE_BEGIN
  ...
  OS_CONFIG_BEGIN(0)
    ...
    //=============================================================================
    //  EI Interrupts Configuration (CORE 0)
    //=============================================================================
  
    OS_INTERRUPT_BEGIN(0)
  ...
  #else
      OS_INTERRUPT_CAT2_DEF(SysTickTimer, 4, NOT_NESTED)  /* SIO_IRQ_MTIMECMP_IRQn   */
  #endif
  ...
  OS_CONFIG_BEGIN(1)
      ...
      OS_TASK_BEGIN(1)
        OS_TASK_DEF(T3, 1, 1024, 1, OS_AUTOSTART, EXTENDED, FULL_PREEMPT)
        OS_TASK_DEF(T4, 5, 1024, 1, OS_AUTOSTART, EXTENDED, FULL_PREEMPT)
      OS_TASK_END
      
      OS_EVENT_BEGIN
        OS_EVENT_DEF(EVT_BLINK_RED_LED_FAST, (1UL << 0))
        OS_EVENT_DEF(EVT_BLINK_RED_LED_SLOW, (1UL << 1))
      OS_EVENT_END
      
      OS_ALARM_BEGIN(1)
        OS_ALARM_DEF(ALARM_BLINK_RED_LED_FAST, ALARM_SET_EVENT, EVT_BLINK_RED_LED_FAST, T1, 0)
        OS_ALARM_DEF(ALARM_BLINK_RED_LED_SLOW, ALARM_SET_EVENT, EVT_BLINK_RED_LED_SLOW, T2, 0)
      OS_ALARM_END
    ...
    //=============================================================================
    //  EI Interrupts Configuration (CORE1)
    //=============================================================================
  
    OS_INTERRUPT_BEGIN(1)
  #ifdef CORE_FAMILY_ARM
      OS_INTERRUPT_CAT2_DEF(Undefined, 0, NOT_NESTED)  /* Reserved                */
      OS_INTERRUPT_CAT2_DEF(Undefined, 0, NOT_NESTED)  /* Reserved                */
      OS_INTERRUPT_CAT2_DEF(Undefined, 0, NOT_NESTED)  /* NMI                     */
